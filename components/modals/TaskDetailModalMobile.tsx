  ...
  return (
    <Modal visible={visible} animationType="fade" transparent onRequestClose={onClose}>
      <View className="flex-1 items-center justify-end bg-[rgba(0,0,0,0.72)] p-0">
        ...
        <View
          className="w-full overflow-hidden rounded-t-[24px]"
          style={{
        ...
        >
          ...
          <SafeAreaView className="flex-1 bg-[rgba(19,19,19,0.78)]">
            ...
            <ScrollView className="max-h-[360px] bg-[rgba(19,19,19,0.78)]" showsVerticalScrollIndicator={false}>
              <View className="p-[22px]">
                ...
                <Text className="mb-2 font-mono text-[10px] uppercase tracking-[1.2px] text-void-text-secondary">Description</Text>
                ...
                <View className="mb-6 flex-row gap-5">
                  <View className="flex-1">
                    <Text className="mb-1.5 font-mono text-[10px] uppercase tracking-[1.2px] text-void-text-secondary">Subject</Text>
                    <Text className="font-body text-[14px] text-void-text-primary">{task.subject}</Text>
                  </View>
                  <View className="flex-1">
                    <Text className="mb-1.5 font-mono text-[10px] uppercase tracking-[1.2px] text-void-text-secondary">Chapter</Text>
            ...
            <ScrollView className="max-h-[300px] bg-[rgba(25,25,25,0.74)]" showsVerticalScrollIndicator={false}>
              <View className="gap-[18px] p-5">
                ...
                >
                  <Text className="mb-1.5 font-mono text-[10px] uppercase tracking-[1.2px] text-void-text-secondary">Deadline</Text>
